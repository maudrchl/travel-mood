<template>
  <div class="detail-trip" ref="main">
    <div class="header-trip">
        <h1 class="header-title" ref="title">Norway</h1>
...
methods: {
    mountAnimation: function(delay) {
      ...
      timeline
        .from(this.$refs.title, .5, { y: '30px', opacity: 0, ease: Power1.easeOut }, delay + 0)
    }
  }
}
